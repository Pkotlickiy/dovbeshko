    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          icon: <FileText className="h-5 w-5" />,
          details:
            "Адвокат организует проведение оценки наследственного имущества независимым оценщиком. Это необходимо для расчета государственной пошлины за выдачу свидетельства о праве на наследство и для справедливого раздела имущества между наследниками.",
        },
        {
