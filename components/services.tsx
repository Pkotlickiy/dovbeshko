        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="text-lg text-muted-foreground text-center max-w-3xl mx-auto mb-12">
              Я и моя команда оказывает комплексную юридическую поддержку как гражданам, так и организациям. В основе моей
              деятельности лежит персональный подход к каждому клиенту, высокий профессионализм и строгое соблюдение
              конфиденциальности.
            </p>
          </div>
        </div>
