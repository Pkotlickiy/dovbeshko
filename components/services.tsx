        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="text-lg text-muted-foreground text-center max-w-3xl mx-auto mb-12">
              Предоставляю со своей командой полный спектр юридических услуг для физических и юридических лиц.
              Индивидуальный подход к каждому доверителю, профессионализм и гарантия конфиденциальности — основа нашей
              работы.
            </p>
          </div>
        </div>
