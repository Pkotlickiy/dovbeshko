      ...
      <div className="container relative grid items-center gap-6 px-4 md:grid-cols-2 md:px-6 lg:gap-10">
        <div className="flex flex-col gap-4">
          <AnimatedItem>
            ...
            >
              Профессиональная юридическая помощь в Московском районе СПб. Защита ваших прав и интересов от земельного
              права до уголовных дел.
            </motion.p>
          </AnimatedItem>
          ...
          <AnimatedItem delay={0.1}>
            ...
            >
              ...
              права и наследственных споров до уголовных дел и военных вопросов. Индивидуальный подход к каждому клиенту
              с ориентацией на эффективный результат.
            </motion.p>
          </AnimatedItem>
