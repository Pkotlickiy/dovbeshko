...
const contactFaqs = [
  ...
  },
  {
    ...
    answer:
      "Офис расположен по адресу: Московский проспект 143, Санкт-Петербург, 196105. Всего 1 минута пешком от станции метро 'Электросила'. Также можно доехать на автобусах 3, 26, 50, 62, 63, 72 или троллейбусах 17, 24, 26.",
  },
]
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-[#603a30]">
                      <li>Станция метро "Электросила" - 1 минута пешком</li>
                  ...
                  <div>
                    ...
                    <p className="text-[#603a30]">Рядом с офисом есть бесплатная парковка для доверителей</p>
                  </div>
                </div>
              </div>
            </div>
