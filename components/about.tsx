      ...
      <div className="container relative px-4 md:px-6">
        <div className="grid gap-10 md:grid-cols-2 lg:gap-16">
          <div className="flex flex-col justify-center space-y-6">
            ...
            <div className="mt-6 p-4 bg-amber-50 border-l-4 border-amber-500 text-amber-700 rounded-md">
              <p className="font-medium">Профессиональный подход:</p>
              <p className="mt-1">
                В своей работе я руководствуюсь принципами профессионализма и этики. Я прилагаю максимум усилий для
                достижения наилучшего результата в каждом деле, однако исход зависит от множества факторов. Моя задача —
                обеспечить квалифицированную юридическую помощь и защиту ваших интересов на всех этапах правового
                процесса.
              </p>
            </div>
          </div>
