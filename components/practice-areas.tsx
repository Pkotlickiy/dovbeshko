  ...
  const practiceAreas: PracticeArea[] = [
    {
      ...
      description: "Защита по уголовным делам любой сложности",
    ...
    {
      title: "Недвижимость",
      description: "Сопровождение сделок с недвижимостью и разрешение споров",
    ...
    },
    {
      ...
      description: "Решение земельных споров и оформление прав на землю",
      href: "/practice/land",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
      ...
      description: "Представительство в арбитражных судах по коммерческим спорам",
    ...
    },
    {
      ...
      description: "Оформление наследства и разрешение наследственных споров",
    ...
    },
    {
      ...
      description: "Взыскание неосновательного обогащения и возврат имущества",
    ...
    {
      title: "Военное право",
      description: "Юридическая помощь военнослужащим и их семьям",
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Области практики</h2>
            <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Специализируюсь на различных отраслях права, предоставляя квалифицированную юридическую помощь
            </p>
          </div>
        </div>
